/*REEMPLAZAR <header>:  <div id="site-nav"></div> <footer>: <div id="site-footer"></div> 
AGREGAR en el <head> (después de </style>: <link rel="stylesheet" href="/components.css"> <script src="/components.js" defer></script> 
ELIMINAR del HTML: new Date().getFullYear();  nav-shell scroll  burger/mob-menu 
*/
(function () {
  'use strict';
